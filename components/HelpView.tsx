      ...
      <div className="bg-white p-6 rounded-lg shadow border-l-4 border-slate-500">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-2">
            ...
            <button type="button" onClick={handlePrint} className="text-sm px-3 py-1 bg-slate-100 hover:bg-slate-200 rounded text-slate-600 transition">
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-sm w-full p-6 text-center">
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                className="px-4 py-2 rounded border border-slate-300 hover:bg-slate-50 dark:border-slate-500 dark:hover:bg-slate-700"
              >
      ...
      {pendingImportFile && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 animate-fade-in">
          <div className="bg-white rounded-lg shadow-xl max-sm w-full p-6 text-center">
            ...
            <div className="flex justify-center gap-4">
              <button type="button" onClick={cancelImport} className="px-4 py-2 rounded border border-slate-300 hover:bg-slate-50 dark:border-slate-500 dark:hover:bg-slate-700">
                {translations.common.cancel}
              </button>
