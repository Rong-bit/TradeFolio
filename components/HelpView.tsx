  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow border-l-4 border-amber-500">
         ...
         <div className="text-sm text-slate-700 dark:text-amber-100 leading-relaxed bg-amber-50 dark:bg-amber-900/20 p-4 rounded border border-amber-100 dark:border-amber-700/40">
