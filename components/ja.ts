...
- 証券会社または金融機関が提供するリアルタイム見積もりを基準とすることをお勧めします。`,
  ...
  transactionForm: {
    ...
    divAssistantTitle: '税引後試算（入金前の照合）',
    divAssistantGross: '税引前総額（グロス）',
    divAssistantOther: 'その他控除（送金手数料など）',
    divAssistantNhiMode: '二代健保2.11%の端数',
    divAssistantNhiFloor: '切り捨て',
    divAssistantNhiRound: '四捨五入',
    divAssistantComputedNet: '試算の手取り',
    divAssistantApplyNet: '手取りを金額に反映',
