...
const de: Translations = {
  ...
  history: { ...en.history, includeCashFlow: 'Kassenfluss-Einträge einbeziehen', showingRecords: '{count} Einträge angezeigt', includeCashFlowDesc: 'Aktivieren, um Einzahlungen, Auszahlungen, Überweisungen usw. zur Anzeige von Kontostandsänderungen anzuzeigen' },
...
const fr: Translations = {
  ...
  dashboard: { ...en.dashboard, netCost: 'Investi net', totalAssets: 'Actif total', totalPL: 'Gain/Perte', deposit: 'Dépôt(+)', withdraw: 'Retrait(-)', taiwanDollar: 'TWD', displayCurrency: 'Devise d\'affichage', ntd: 'Dollar taïwanais', usd: 'Dollar américain', aiAdvisor: 'Conseiller Gemini AI', notInvestmentAdvice: 'Pas un conseil en investissement.' },
  funds: { 
    ...en.funds, 
  ...
  history: { ...en.history, includeCashFlow: 'Inclure les enregistrements de flux de trésorerie', showingRecords: 'Affichage de {count} enregistrements', includeCashFlowDesc: 'Cocher pour afficher les dépôts, retraits, virements, etc. pour voir l\'évolution du solde' },
...
const pt: Translations = {
  ...
  dashboard: { ...en.dashboard, netCost: 'Investimento líquido', totalAssets: 'Patrimônio total', totalPL: 'Lucro/Perda', deposit: 'Depósito(+)', withdraw: 'Saque(-)', taiwanDollar: 'TWD', displayCurrency: 'Moeda de exibição', ntd: 'Dólar de Taiwan', usd: 'Dólar americano', aiAdvisor: 'Assistente Gemini AI', notInvestmentAdvice: 'Não é aconselhamento de investimento.' },
  funds: { 
    ...en.funds, 
  ...
  history: { ...en.history, includeCashFlow: 'Incluir registros de fluxo de caixa', showingRecords: 'Exibindo {count} registros', includeCashFlowDesc: 'Marque para mostrar depósitos, saques, transferências etc. para ver alterações do saldo' },
