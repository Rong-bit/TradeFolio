...
* **상환**: 증권 계좌→부채 계좌 송금.
* **대시보드**: 차입 카드(잔액, 한도 사용률, 다음 달 예상 이자), 총자산에 부채 합계·순자산 표시.
...
Q: 「차입／한도／사용률」 계산은?
A: **차입**＝부채 계좌 현재 잔액. **한도**＝설정한 신용 한도. **사용률**＝차입÷한도×100%(최대 100%).

Q: 「다음 달 예상 이자」 계산은?
A: **예상 이자**＝잔액×연이율(%)÷100÷12. 예: 200만·2.2%→약 **3,667**/월. 단리·한 달 고정 잔액 **참고치**입니다.

Q: 차입과 순투입·XIRR·순자산 관계는?
A: **차입 인출／상환**(부채↔증권 송금)은 **순투입·XIRR**에 포함. **대출 이자**는 제외. **순자산**＝총자산−부채 합계.
