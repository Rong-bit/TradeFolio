...
export const ko: Translations = {
  ...
  stockSplit: {
    ...
    hint: 'Transactions keep original share counts and prices. Split events adjust holdings only at calculation time from the effective date.',
    ticker: 'Symbol',
    ...
    note: 'Note',
    notePlaceholder: 'e.g. Jan 2024 stock split',
    addButton: 'Add Stock Split Event',
    listTitle: 'Configured Stock Splits',
    totalCount: '{count} record(s)',
    emptyList: 'No split events yet',
    tickerRequired: 'Please enter a symbol',
    dateRequired: 'Please select an effective date',
    invalidRatio: 'Before/after shares must be positive integers',
    duplicateError: 'A split for this symbol, market and date already exists',
    addSuccess: 'Stock split event added',
    deleteSuccess: 'Stock split event deleted',
