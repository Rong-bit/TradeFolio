...
- 증권사 또는 금융 기관이 제공하는 실시간 시세를 기준으로 하는 것을 권장합니다.`,
  ...
  transactionForm: {
    ...
    feesShort: '수수료',
    formulaNote: '(대만주 내림)',
    divAssistantTitle: 'Net payout helper (pre-entry check)',
    divAssistantGross: 'Gross amount (before NHI & other fees)',
    divAssistantOther: 'Other deductions (e.g. wire fee, TWD)',
    divAssistantNhiMode: 'NHI 2.11% rounding',
    divAssistantNhiFloor: 'Floor',
    divAssistantNhiRound: 'Round',
    divAssistantComputedNet: 'Computed net',
    divAssistantApplyNet: 'Apply net to amount',
