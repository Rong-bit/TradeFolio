...
- É recomendado referir-se a cotações em tempo real fornecidas por empresas de valores mobiliários ou instituições financeiras.`,
  ...
  transactionForm: {
    ...
    transferInMarket: 'Mercado de entrada',
    transferInTicker: 'Símbolo de entrada',
    transferInPrice: 'Preço de entrada',
    transferInQuantity: 'Quantidade de entrada',
    ...
    errorInvalidTransferIn: 'Verifique mercado, símbolo, preço e quantidade da transferência de entrada.',
