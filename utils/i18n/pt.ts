...
export const pt: Translations = {
  ...
  dashboard: {
    ...
    accountReturnRateTooltip:
      'Retorno acumulado = P/L ÷ denominador. Entrada liquida; se ≤ 0 custo acumulado. Transferencia com valor de mercado. Sem posicao = encerrado.',
  ...
  dividendTax: {
    ...
    pendingActualEstAmount: 'Valor estimado',
    pendingActualAccount: 'Conta de entrada',
    pendingActualNoteTemplate: 'Importação automática MoneyDJ: por ação {perShare}, posição {qty}',
  },
  funds: { 
    ...en.funds, 
...
- É recomendado referir-se a cotações em tempo real fornecidas por empresas de valores mobiliários ou instituições financeiras.`,
  ...
  transactionForm: {
    ...
    transferBookPrice: 'Custo contabil por acao',
    transferBookPriceHint: 'Para transferencia contabil; valor de mercado abaixo para desempenho.',
    transferValuationPrice: 'Preco de mercado no dia da transferencia',
    transferValuationHint: 'Fecha conta de origem; custo na conta destino.',
