...
- 建議以證券公司或金融機構提供的即時報價為準。`,
  ...
  transactionForm: {
    ...
    feesShort: '手續費',
    formulaNote: ' (台股向下取整)',
    divAssistantTitle: '稅後試算（入帳前核對）',
    divAssistantGross: '原始應發總額（毛額）',
    divAssistantOther: '其他入帳扣款（匯費等）',
    divAssistantNhiMode: '二代健保 2.11% 計算',
    divAssistantNhiFloor: '無條件捨去',
    divAssistantNhiRound: '四捨五入',
    divAssistantComputedNet: '試算實領',
    divAssistantApplyNet: '帶入實領金額',
