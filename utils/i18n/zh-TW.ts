...
export const zhTW: Translations = {
  ...
  funds: {
    ...
    last30Days: '最近30天',
    thisYear: '今年',
    confirmClearAll: '確認清空篩選的 {count} 筆資金紀錄？',
    confirmClearAllMessage: '此操作將刪除目前篩選條件下的入金、出金、轉帳與利息紀錄，且無法復原。建議先備份資料。',
    confirmClear: '確認清空',
  },
  history: {
  ...
  help: {
    ...
    contact: '問題回報',
    contactTitle: '遇到問題？',
    contactDesc: '若有任何功能異常、Bug 或功能建議，歡迎回報給開發者。公餘時間維護，回覆較慢請見諒。',
    contactEmail: '問題回報',
    documentation: '使用說明',
    copyAll: '複製全文',
    copied: '已複製!',
...
- 建議以證券公司或金融機構提供的即時報價為準。`,
  ...
  appMessages: {
    ...
    contactSubject: 'TradeView 問題回報',
    contactBody: 'Hi 管理員,\n\n我的帳號是: {user}\n\n【問題描述】\n請在此說明您遇到的 Bug 或問題：\n\n\n\n謝謝協助。',
    contactSentSuccess: '問題回報已送出！開發者將盡快查閱，謝謝您的回饋。',
    contactMailtoFallback: '無法直接送出回報，已為您開啟 Gmail 撰寫郵件。請補充問題後按「傳送」。',
    contactStaticPagesHint: '正在開啟 Gmail 撰寫郵件，並複製回報內容到剪貼簿。\n\n請補充問題說明後按「傳送」。\n\n若 Gmail 未開啟，請手動前往 mail.google.com 或寄信至：{email}',
