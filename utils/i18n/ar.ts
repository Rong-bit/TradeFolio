...
- يُنصح بالرجوع إلى الأسعار في الوقت الفعلي المقدمة من شركات الأوراق المالية أو المؤسسات المالية.`,
  ...
  transactionForm: {
    ...
    transferInMarket: 'سوق التحويل الوارد',
    transferInTicker: 'رمز التحويل الوارد',
    transferInPrice: 'سعر التحويل الوارد',
    transferInQuantity: 'كمية التحويل الوارد',
    ...
    errorInvalidTransferIn: 'يرجى التحقق من السوق والرمز والسعر والكمية للتحويل الوارد.',
