...
* **فائدة القرض**: مصروف فائدة؛ في **الوساطة** يقل النقد، في **الخصوم** تزيد الدين.

### الائتمان / حساب الخصوم
* **نوع الحساب**: في إدارة الحسابات اختر « خصوم (دين) »؛ اختياري: نوع القرض، **المعدل السنوي (%)**، **حد الائتمان**، حساب وساطة مرتبط.
* **السحب (موصى به)**: **تحويل** فقط **خصوم → وساطة**؛ لا تستخدم **استيراد** إضافياً على الخصوم (يتجنب تضاعف الدين).
* **السداد**: تحويل وساطة → خصوم (المبلغ الفعلي المدفوع—أصل فقط أو أصل+فوائد).
* **السداد الكامل**: يُحكم بـ **رصيد الخصوم** (مجموع القيود). **رصيد صفر = مسدد**؛ قد يتجاوز إجمالي السداد المبلغ الأصلي (طبيعي مع الفوائد).
* **بعد السداد**: احتفظ بالحساب والسجلات؛ راجع في إدارة الحسابات / الأموال.
* **لوحة التحكم**: بطاقات الدين والتنبيهات فقط عند **رصيد > 0**. عند الصفر تُخفى قسم الدين. إجمالي الدين وصافي الثروة فقط عند وجود رصيد.
...
س: كيف أُعد حساب قرض وأُسجّل السحب والسداد؟
ج: **إدارة الحسابات** → نوع « خصوم (دين) »، المعدل السنوي، حد اختياري. **السحب**: الأموال → تحويل → خصوم → وساطة. **السداد**: وساطة → خصوم. رصيد الخصوم = أصل الدين (يشمل فائدة مسجّلة على الخصوم).

س: لماذا لا أستخدم « استيراد » على حساب الخصوم لصرف البنك؟
ج: الاستيراد + التحويل قد **يضاعف** الدين المعروض. صافي الاستثمار/XIRR يتجاهل استيراد الخصوم لكن الرصيد قد يبقى مرتفعاً. **تحويل واحد** خصوم→وساطة فقط.

س: كيف أعرف أن القرض مُسدَّد بالكامل؟ وماذا إذا تجاوز إجمالي السداد المبلغ الأصلي؟
ج: المعيار **رصيد الخصوم = 0**، وليس «إجمالي السداد = المبلغ الأصلي». السحب والفائدة على الخصوم تزيد الرصيد؛ السداد يقلله. دفع أكثر من الأصل طبيعي. سجّل كل خصم بنكي؛ عند رصيد صفر تُخفى واجهة الدين—تحقق في إدارة الحسابات.

س: كيف يُحسب « المستخدم / الحد / نسبة الاستخدام »؟
ج: يُعرض فقط عند **رصيد > 0**. **المستخدم** = رصيد الخصوم الحالي. **الحد** = حد الائتمان. **الاستخدام** = مستخدم ÷ حد × 100% (بحد أقصى 100%).

س: كيف تُحسب « فائدة الشهر القادم المقدرة »؟
ج: **التقدير** = الرصيد × المعدل السنوي(%) ÷ 100 ÷ 12. مثال: 2,000,000 @ 2.2% → نحو **3,667**/شهر. تقدير برصيد ثابت؛ البنك قد يختلف.

س: ما علاقة القرض بصافي الاستثمار وXIRR وصافي الثروة؟
ج: **سحب/سداد القرض** يدخل **صافي الاستثمار** و**XIRR**؛ **فائدة القرض** لا. **صافي الثروة** = إجمالي الأصول − إجمالي الدين. عند **رصيد صفر** تُخفى بطاقات الدين والتنبيهات، ويبقى السجل في تفصيل صافي الاستثمار. فسّر XIRR بحذر إن استخدمت رافعة مالية.
