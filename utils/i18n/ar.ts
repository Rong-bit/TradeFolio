...
export const ar: Translations = {
  ...
  dashboard: { 
    ...
    accountReturnRateTooltip:
      'العائد التراكمي = الربح/الخسارة ÷ المقام. صافي الإيداع؛ إن ≤ 0 التكلفة المتراكمة. تحويل بقيمة السوق.',
  ...
  dividendTax: {
    ...
    pendingActualNoteTemplate: 'استيراد تلقائي من MoneyDJ: لكل سهم {perShare}، الكمية {qty}',
  },
  funds: { 
    ...en.funds,
    title: 'إدارة الأموال',
...
* **فائدة القرض**: مصروف فائدة؛ عند تسجيلها في **حساب الوساطة** يقل النقد (لا تظهر حسابات الخصوم في القائمة).

### الائتمان / حساب الخصوم (أسئلة وأجوبة)

س: ماذا يعني « الرصيد » في حساب الخصوم؟
ج: **أصل الدين المستحق** (ما تدين به للبنك)، وليس نقداً متاحاً. رصيد صفر = مسدد.

س: كيف أنشئ حساب خصوم؟
ج: **إدارة الحسابات** → إضافة حساب → نوع **خصوم (دين)** → الاسم والعملة والمعدل السنوي وحد الائتمان (اختياري). الرصيد الابتدائي **0**.

س: كيف أسجّل صرف البنك إلى الوساطة؟
ج: الأموال → **تحويل** → **خصوم → وساطة** → مبلغ الصرف. **قيد واحد فقط**؛ لا تستخدم **استيراد** إضافياً على الخصوم (يتجنب العد المزدوج).

س: كيف أسجّل سداد الأصل؟
ج: الأموال → **تحويل** → **وساطة → خصوم** → المبلغ = **الأصل فقط**. رصيد الخصوم يتتبع الأصل فقط ويجب أن يصبح صفراً بعد السداد.

س: أين أسجّل فائدة القرض؟
ج: **حساب الوساطة**. الأموال → فائدة القرض → اختر وساطة (القائمة للوساطة فقط). إذا خصم البنك « أصل + فائدة » معاً، **قيدان**: ① تحويل (وساطة→خصوم) لل**أصل**؛ ② فائدة القرض على **الوساطة** للفائدة.

س: متى يُعتبر القرض مسدداً؟
ج: عندما **يصل الرصيد إلى صفر** (الدفع الزائد يُعتبر مسدداً أيضاً). إجمالي السداد مع الفوائد غالباً يتجاوز المبلغ الأصلي—وهذا طبيعي.

س: هل أحذف الحساب بعد السداد؟
ج: لا. احتفظ بالحساب والسجل. عند رصيد صفر تُخفى قسم الدين في لوحة التحكم.

س: كيف تظهر لوحة التحكم عند وجود دين؟
ج: **عمود « الرصيد / الدين » > 0** (أصل الدين): بطاقات الائتمان والدين، البطاقة الرئيسية **صافي الثروة** (إجمالي الأصول − إجمالي الدين). **العمود = 0**: قسم الدين مخفي، البطاقة الرئيسية **إجمالي الأصول**.

### أنواع المعاملات
* **Buy/Sell**: شراء/بيع عام.
* **إعادة استثمار التوزيعات (DRIP)**: يزيد عدد الأسهم (توزيع أسهم أو إعادة استثمار).
...
ج: عائد لوحة التحكم السنوي (XIRR) هو عائد مرجح بالأموال من الإيداعات والسحوبات المؤرّخة والأصول الإجمالية الحالية—وليس CAGR المعتمد على السعر فقط. يستخدم محاكي تخصيص الأصول CAGR في الاستعلام التلقائي.
...
ج: يُعرض فقط عندما **عمود « الرصيد / الدين » > 0** لذلك الحساب. **المستخدم** = قيمة العمود (أصل الدين المتراكم). **الحد** = حد الائتمان (نفس العملة). **الاستخدام** = مستخدم ÷ حد × 100% (بحد أقصى 100%). بدون حد لا يظهر شريط التقدم.

س: كيف تُحسب « فائدة الشهر القادم المقدرة »؟
ج: **التقدير** = الرصيد الحالي × المعدل السنوي(%) ÷ 100 ÷ 12. مثال: 2,000,000 مستحق @ 2.2% → نحو **3,667**/شهر. تقدير بفائدة بسيطة؛ البنك قد يختلف. @ = المعدل السنوي للحساب.

س: ما علاقة القرض بصافي الاستثمار وXIRR وصافي الثروة؟
ج: **سحب/سداد القرض** (خصوم↔وساطة) يدخل **صافي الاستثمار** و**XIRR** (رافعة مالية)؛ **فائدة القرض** لا. **إجمالي الأصول** = المراكز + نقد الوساطة؛ **إجمالي الدين** = مجموع أرصدة الخصوم (محوّلة)؛ **صافي الثروة** = إجمالي الأصول − إجمالي الدين. عند رصيد صفر تُخفى البطاقات والتنبيهات، ويبقى السجل في تفصيل صافي الاستثمار. فسّر XIRR بحذر إن استخدمت رافعة مالية.

س: كيف يتم تسجيل تحويلات الأسهم (من وسيط A إلى وسيط B)؟
ج: **موصى به (خطوة واحدة)**: **إضافة سجل** → النوع **تحويل خارج** → الحساب المصدر (A) → التاريخ والسوق والرمز والكمية → اختر **حساب الوجهة (B)** ثم احفظ. التطبيق ينشئ **TRANSFER_OUT و TRANSFER_IN معاً**—لا حاجة لإدخال السجل الثاني يدوياً. السجل الداخل التلقائي **رسوم = 0**؛ أدخل **الرسوم على التحويل الخارج**. السعر الافتراضي هو متوسط التكلفة (وليس سعر السوق).

**بعد التحويل**: المراكز تنتقل من A إلى B؛ أرصدة النقد تُحدَّث حسب الرسوم.
...
- يُنصح بالرجوع إلى الأسعار في الوقت الفعلي المقدمة من شركات الأوراق المالية أو المؤسسات المالية.`,
  ...
  transactionForm: {
    ...
    transferBookPriceHint: 'For book transfer; market price below for return.',
    transferValuationPrice: 'Market price on transfer day',
    transferValuationHint: 'Closes source; target cost basis.',
  ...
  appMessages: {
    ...
    cashFlowCleared: '✅ تم مسح جميع سجلات التدفق النقدي!',
    ...
    confirmClearTxTitle: 'تأكيد مسح جميع المعاملات؟',
    confirmClearTxMessage: 'لا يمكن التراجع عن هذا الإجراء. يرجى التأكد من وجود نسخة احتياطية.',
