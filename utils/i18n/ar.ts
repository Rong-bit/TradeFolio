...
* **السداد**: تحويل وساطة → خصوم.
* **لوحة التحكم**: بطاقات دين (الرصيد، استخدام الحد، فائدة الشهر القادم المقدرة)؛ إجمالي الأصول يعرض إجمالي الدين وصافي الثروة.
...
ج: **المستخدم** = رصيد الخصوم الحالي. **الحد** = حد الائتمان (نفس العملة). **الاستخدام** = مستخدم ÷ حد × 100% (بحد أقصى 100%). بلا حد لا شريط تقدم.
...
ج: **سحب/سداد القرض** (خصوم↔وساطة) يدخل **صافي الاستثمار** و**XIRR**؛ **فائدة القرض** لا. **صافي الثروة** = إجمالي الأصول − إجمالي الدين. فسّر XIRR بحذر عند الرافعة المالية.
