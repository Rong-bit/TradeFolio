...
export const ar: Translations = {
  ...
  dashboard: { 
    ...
    annualizedReturn: 'العائد السنوي (IRR)',
    detail: 'التفاصيل',
...
ج: عائد لوحة التحكم السنوي (IRR) هو عائد مرجح بالأموال IRR/XIRR من الإيداعات والسحوبات والأصول الإجمالية الحالية—وليس CAGR المعتمد على السعر فقط. يستخدم محاكي تخصيص الأصول CAGR في الاستعلام التلقائي.
