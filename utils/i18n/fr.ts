...
- Il est recommandé de se référer aux cotations en temps réel fournies par les sociétés de valeurs mobilières ou les institutions financières.`,
  ...
  transactionForm: {
    ...
    transferBookPrice: 'Cout comptable par action',
    transferBookPriceHint: 'Pour le transfert comptable ; valeur de marche ci-dessous pour la performance.',
    transferValuationPrice: 'Prix de marche au jour du transfert',
    transferValuationHint: 'Performance : cloture le compte source ; base de cout sur le compte cible.',
