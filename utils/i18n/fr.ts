...
- Il est recommandé de se référer aux cotations en temps réel fournies par les sociétés de valeurs mobilières ou les institutions financières.`,
  ...
  transactionForm: {
    ...
    transferInMarket: 'Marché entrant',
    transferInTicker: 'Symbole entrant',
    transferInPrice: 'Prix entrant',
    ...
    errorInvalidTransferIn: 'Vérifiez le marché, le symbole, le prix et la quantité du transfert entrant.',
