...
export const de: Translations = {
  ...
  dividendTax: {
    ...
    pendingActualConfirmEditHint: 'Die Felder unten (Datum, Konto, Nettobetrag, Quellensteuer, Notiz usw.) können vor dem Speichern bearbeitet werden.',
    pendingActualConfirmInvalidAmount: 'Bitte einen Nettobetrag größer als 0 eingeben.',
  },
