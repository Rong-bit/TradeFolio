...
export const de: Translations = {
  ...
  funds: { title: 'Fondsverwaltung', operations: 'Aktionen', clearAll: 'Alle löschen', batchImport: 'Import', addRecord: '+ Eintrag', filter: 'Suche/Filter', clearFilters: 'Zurücksetzen', accountFilter: 'Konto', typeFilter: 'Typ', dateFrom: 'Von', dateTo: 'Bis', allAccounts: 'Alle', allTypes: 'Alle', deposit: 'Einzahlung', withdraw: 'Auszahlung', transfer: 'Überweisung', interest: 'Zinsen', loanInterest: 'Kreditzinsen', showRecords: '{count} Einträge', totalRecords: 'Gesamt {total}', last30Days: 'Letzte 30 Tage', thisYear: 'Dieses Jahr', confirmClearAll: 'Alle Fondsdaten löschen?', confirmClearAllMessage: 'Ein- und Auszahlungen werden gelöscht.', confirmClear: 'Löschen' },
  history: {
...
- Es wird empfohlen, sich an Echtzeitkurse zu halten, die von Wertpapierfirmen oder Finanzinstituten bereitgestellt werden.`,
  ...
  transactionForm: {
    ...
    transferBookPrice: 'Buchkosten pro Aktie',
    transferBookPriceHint: 'Fuer Buchuebertrag; Marktpreis unten fuer Performance.',
    transferValuationPrice: 'Marktpreis am Uebertragungstag',
    transferValuationHint: 'Performance: schliesst Quellkonto; Zielkonto Kostenbasis.',
