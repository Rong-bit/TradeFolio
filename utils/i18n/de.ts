...
- Es wird empfohlen, sich an Echtzeitkurse zu halten, die von Wertpapierfirmen oder Finanzinstituten bereitgestellt werden.`,
  ...
  transactionForm: {
    ...
    transferInMarket: 'Einbuchungsmarkt',
    transferInTicker: 'Einbuchungs-Symbol',
    transferInPrice: 'Einbuchungspreis',
    transferInQuantity: 'Einbuchungsmenge',
    ...
    errorInvalidTransferIn: 'Bitte Markt, Symbol, Preis und Menge für die Einbuchung prüfen.',
