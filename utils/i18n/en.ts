...
export const en: Translations = {
  ...
  stockSplit: {
    ...
    hint: 'Transactions keep original share counts and prices. Split events adjust holdings only at calculation time from the effective date. Do not re-enter if post-split trades already use split-adjusted shares.',
    ticker: 'Symbol',
