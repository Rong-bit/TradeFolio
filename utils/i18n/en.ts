...
- It is recommended to use real-time quotes provided by securities companies or financial institutions.`,
  ...
  transactionForm: {
    ...
    transferInMarket: 'Transfer-in Market',
    transferInTicker: 'Transfer-in Ticker',
    transferInPrice: 'Transfer-in Price',
    transferInQuantity: 'Transfer-in Quantity',
    ...
    errorInvalidTransferIn: 'Please check transfer-in market, ticker, price, and quantity',
