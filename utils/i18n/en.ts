...
export const en: Translations = {
  ...
  accounts: {
    ...
    cannotDeleteClosedTitle: 'Cannot delete a closed account',
    cannotDeleteClosedMessage:
      'This account has no holdings and no cash. Deleting it would leave orphaned history. To remove it from the list, hide it instead.',
