...
zhCN.common = { confirm: '确认', cancel: '取消', delete: '删除', edit: '编辑', save: '保存', close: '关闭', loading: '加载中...', search: '搜索', logoutConfirm: '确定要登出系统吗？', upgrade: '升级', footerLocalDataPrivacy: '本应用所有交易数据均存储在本地，保障您的隐私安全。' };
