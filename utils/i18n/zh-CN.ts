...
* **还本**：证券户 → 负债户转账。
* **仪表板**：有负债时会显示「信贷／负债」卡片（欠款、额度使用率进度条、预计下月利息）；总资产卡亦显示负债合计与净资产。
...
A: **已借**＝该负债户目前欠款余额（资金记录累计）。**额度**＝账户设定的信贷额度（与账户同币别）。**使用率**＝已借 ÷ 额度 × 100%（上限显示 100%）。未设定额度则不显示进度条。
...
A: **信贷拨入／还本**（负债户↔证券户转账）会计入**净投入**与**XIRR**（视为杠杆资金）；**信贷利息**不计入净投入。仪表板**总资产**为证券资产＋证券户现金；**负债合计**为各负债户欠款换算加总；**净资产**＝总资产 − 负债合计。年化报酬含借贷时请留意解读。
