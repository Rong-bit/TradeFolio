...
export const hi: Translations = {
  ...
  dashboard: { 
    ...
    totalPL: 'लाभ/हानि', 
    annualizedReturn: 'वार्षिक रिटर्न (IRR)',
    detail: 'विवरण',
...
उ: डैशबोर्ड का वार्षिक रिटर्न (IRR) धन-भारित IRR/XIRR है—जमा/निकासी और वर्तमान कुल संपत्ति से; केवल कीमत आधारित CAGR नहीं। एसेट आवंटन सिमुलेटर में ऑटो-क्वेरी CAGR उपयोग करती है।
