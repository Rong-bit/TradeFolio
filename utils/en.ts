...
export const en: Translations = {
  ...
  dividendTax: {
    ...
    pendingActualDripHint: 'For dividend reinvestment (DRIP), use "+ Add Record" in Transactions — do not click "Add to records" here.',
    pendingActualEmpty: 'No pending actual dividends to record.',
    pendingActualLoading: 'Loading actual dividends...',
