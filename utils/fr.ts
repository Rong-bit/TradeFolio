...
export const fr: Translations = {
  ...
  dividendTax: {
    ...
    pendingActualDripHint: 'Pour le réinvestissement des dividendes (DRIP), utilisez « + Ajouter un enregistrement » dans l\'historique — n\'appuyez pas sur « Ajouter aux transactions » ici.',
    pendingActualEmpty: 'Aucun dividende reel a completer pour le moment.',
    pendingActualLoading: 'Chargement des donnees reales...',
    ...
    pendingActualSourceMoneyDj: 'Donnees',
